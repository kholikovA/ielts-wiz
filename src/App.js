          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                ...
                <span style={{ padding: '0.25rem 0.6rem', borderRadius: '6px', background: 'var(--purple-600)', fontSize: '0.65rem', fontWeight: '600', color: 'white', letterSpacing: '0.5px', lineHeight: '1', alignSelf: 'flex-start' }}>40 TESTS</span>
              </div>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                <span style={{ fontSize: '2.4rem' }}>📄</span>
                <span style={{ padding: '0.25rem 0.6rem', borderRadius: '6px', background: '#3b82f6', fontSize: '0.65rem', fontWeight: '600', color: 'white', letterSpacing: '0.5px', lineHeight: '1', alignSelf: 'flex-start' }}>10 TESTS</span>
              </div>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                <span style={{ fontSize: '2.4rem' }}>📄</span>
                <span style={{ padding: '0.25rem 0.6rem', borderRadius: '6px', background: '#10b981', fontSize: '0.65rem', fontWeight: '600', color: 'white', letterSpacing: '0.5px', lineHeight: '1', alignSelf: 'flex-start' }}>9 TESTS</span>
              </div>

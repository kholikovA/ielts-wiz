          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                ...
                <span style={{ padding: '0.5rem 1.2rem', borderRadius: '4px', background: 'var(--purple-600)', fontSize: '1rem', fontWeight: '800', color: 'white', letterSpacing: '0.6px', lineHeight: '1.5' }}>40 TESTS</span>
              </div>

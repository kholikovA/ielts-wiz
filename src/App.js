          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                ...
                <span style={{ padding: '0.3rem 0.3rem', borderRadius: '8px', background: 'var(--purple-600)', fontSize: '0.8rem', fontWeight: '600', color: 'white', letterSpacing: '0.5px', lineHeight: '1' }}>40 TESTS</span>
              </div>

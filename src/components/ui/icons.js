...
// Lucide-style line icons, hand-inlined to avoid an npm dependency.
// Usage: <Icon name="headphones" size={20} />

const PATHS = {
  // Skill icons (replace 🎧 📖 ✍️ 🎤)
  ...
  sparkle: <><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z"/><path d="M19 14l.7 2L22 16.7 20 17.4 19 19l-.7-2L16 16.7l2-.7z"/></>,
  award: <><circle cx="12" cy="8" r="6"/><polyline points="9 13 7 22 12 19 17 22 15 13"/></>,
  ...
  // Numbered steps / sequence (used by HowItWorks)
  ...
  quote: <><path d="M3 21c3-1 7-5 7-12V3H3v9h4"/><path d="M14 21c3-1 7-5 7-12V3h-7v9h4"/></>,
};

export default function Icon({ name, size = 20, strokeWidth = 2, style, className, ...rest }) {
